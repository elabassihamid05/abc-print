...
const _products = [
  {
    ...
    shortDescription:
      "<h4>Découvrez le dernier iPhone avec son design révolutionnaire, son processeur A17 Pro et sa caméra professionnelle.</h4>",
    richEditorContent:
      "<p>L'iPhone 15 Pro Max repousse les limites de l'innovation avec son écran Super Retina XDR de 6,7 pouces, son processeur A17 Pro ultra-rapide et sa nouvelle caméra 48MP. Profitez d'une autonomie exceptionnelle, d'une connectivité 5G avancée et d'un design en titane premium.</p>",
    phone: phone,
  },
  {
    id: 2,
    ...
    shortDescription:
      "<h4>Le smartphone ultime avec S Pen intégré, écran Dynamic AMOLED 2X et processeur Snapdragon 8 Gen 3.</h4>",
    richEditorContent:
      "<p>Le Samsung Galaxy S24 Ultra redéfinit l'expérience smartphone avec son écran Dynamic AMOLED 2X de 6,8 pouces, son S Pen intégré et sa batterie de 5000mAh. Doté d'un système de caméra professionnel à 200MP.</p>",
    phone: phone,
  },
  {
    id: 3,
    ...
    image:
      "https://images.unsplash.com/photo-1695048133148-53895a7cec8f?q=80&w=1000",
    shortDescription:
      "<h4>La montre connectée la plus avancée avec double tap, écran Retina toujours activé et suivi santé complet.</h4>",
    richEditorContent:
      "<p>L'Apple Watch Series 9 vous offre une expérience de montre connectée inégalée avec son écran Retina toujours activé, son suivi santé avancé et sa nouvelle fonctionnalité Double Tap.</p>",
    phone: phone,
  },
  {
    id: 4,
    ...
    image:
      "https://images.unsplash.com/photo-1706003625035-5a4b3c4a0b0f?q=80&w=1000",
    shortDescription:
      "<h4>La montre connectée premium avec écran AMOLED, suivi santé avancé et compatibilité Android/iOS.</h4>",
    richEditorContent:
      "<p>La Samsung Galaxy Watch 6 Pro combine élégance et performance avec son écran AMOLED rotatif, son suivi santé complet et sa compatibilité universelle.</p>",
    phone: phone,
  },
  {
    id: 5,
    ...
    image:
      "https://images.unsplash.com/photo-1695048133148-53895a7cec8f?q=80&w=1000",
    shortDescription:
      "<h4>Écouteurs sans fil avec réduction de bruit active et son spatial personnalisé.</h4>",
    richEditorContent:
      "<p>Les AirPods Pro 2 offrent une expérience audio exceptionnelle avec leur réduction de bruit active améliorée, leur son spatial personnalisé et leur nouvelle puce H2.</p>",
    phone: phone,
  },
  {
    id: 6,
    ...
    image:
      "https://images.unsplash.com/photo-1706003625035-5a4b3c4a0b0f?q=80&w=1000",
    shortDescription:
      "<h4>La tablette la plus puissante avec écran Liquid Retina XDR et puce M2.</h4>",
    richEditorContent:
      "<p>L'iPad Pro M2 repousse les limites de la créativité avec son écran Liquid Retina XDR de 12,9 pouces, sa puce M2 ultra-rapide et son support Apple Pencil.</p>",
    phone: phone,
  },
];
...
export default function ArtisanaMaroc() {
  ...
  const {
    ...
    "https://script.google.com/macros/s/AKfycbxI307LOquAuK9PIHlZiYctMmesiq2qA1sB6wlZiD-ojZYQoQ9eVcu0msmVZTKziJY3/exec"
  );
        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex items-center gap-2 mb-6">
                ...
                >
                  <path
                    d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM16 16H8V14H16V16ZM16 12H8V10H16V12ZM16 8H8V6H16V8Z"
                    fill="currentColor"
                  />
                </svg>
              ...
              <h1 className="text-4xl font-bold leading-tight text-gray-900 md:text-6xl">
                Découvrez la
                <span className="text-blue-600"> Technologie Premium</span>
              </h1>
              <p className="mt-6 text-lg leading-relaxed text-gray-600">
                Explorez notre sélection exclusive de produits tech haut de
                gamme. Des smartphones aux montres connectées, trouvez
                l'innovation qui vous correspond.
              </p>
            </motion.div>
          ...
          >
            <div className="relative h-[500px] w-full rounded-2xl overflow-hidden">
              <img
                src="https://i.imgur.com/e72ZCn7.jpeg"
